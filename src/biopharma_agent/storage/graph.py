...
class LocalKnowledgeGraphWriter:
    ...
    def write_insight(self, result: PipelineResult) -> None:
        ...
        nodes = self._nodes_from_result(result)
        edges = self._edges_from_result(result)
    ...
    def _nodes_from_result(self, result: PipelineResult) -> list[GraphNode]:
    ...
    def _edges_from_result(self, result: PipelineResult) -> list[GraphEdge]:
        insight = result.insight
